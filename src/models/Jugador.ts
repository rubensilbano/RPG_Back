...
// AQUI SE GUARDA UNA ABSTRACCION DEL REGISTRO.
    ...
    // Schema	ES LA ESTRUCTURA U OBJETO QUE DEBEN TENER LOS REGISTROS DE JUGADOR
...
const jugadorSchema = new Schema({
    ...
    HEROE1: {
        type: Object,
        trim: true,
        default: {"NIVEL": 0, "EXPERIENCIA": 0, "OBJETOS": [0, 0, 0, 0, 0], "PUNTOSBATALLA": [0, 0]}
    },
    HEROE2: {
        type: Object,
        trim: true,
        default: {"NIVEL": 1, "EXPERIENCIA": 0, "OBJETOS": [0, 0, 0, 0, 0], "PUNTOSBATALLA": [720, 0]}
    },
    HEROE3: {
        type: Object,
        trim: true,
